...
gulp.task('alternateScripts', ['workerScripts'], function() {
    ...
    return gulp.src(['htdocs/**/*(serviceWorker.js|card-game.js|card-game-shared.js|worker-pathfinding.js|worker-lightmap.js|hnefatafl.js|hnefatafl-shared.js|worker-hnefatafl.js|worker-canvas-reflections.js)'])
        .pipe(rename({
            suffix: '.min'
        }))
        .pipe(uglify())
