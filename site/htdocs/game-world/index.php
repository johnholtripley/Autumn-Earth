...
<div id="cardAlbum" class="active"><div class="draggableBar">Card album</div><div id="cardAlbumList"></div><button id="toggleActiveCards">Show only collected cards</button></div>
