...
function isPetBlocked(whichPet, whichFacing) {
    ...
    switch (whichFacing) {
        case 'n':
            if (isAPetTerrainCollision(getTileCentreCoordX(whichPet.tileX), getTileCentreCoordY(whichPet.tileY - 1))) {
                isBlocked = true;
            }
            break;
        ...
        case 'e':
            if (isAPetTerrainCollision(getTileCentreCoordX(whichPet.tileX + 1), getTileCentreCoordY(whichPet.tileY))) {
                isBlocked = true;
            }
            break;
