...
for ($i=0;$i<count($allYouTubeVideos);$i++) {
  array_push($socialContent,array('<div class="videoWrapper youtube"><iframe width="420" height="315" src="https://www.youtube.com/embed/'.$allYouTubeVideos[$i][0].'?modestbranding=1&amp;controls=0&amp;showinfo=0&amp;rel=0&amp;fs=1" frameborder="0" allowfullscreen></iframe></div>',$allYouTubeVideos[$i][1],$allYouTubeVideos[$i][2]));
}
