...
(1, 'Eila Myrborn', 'eila-myrborn', 999, -1, NULL, 1, '2018-05-09 13:09:47', 'female', 'huldra', 'eastern-continent', 206, 340),
(2, 'Nellaith Wispfael', 'nellaith-wispfael', 999, -1, NULL, 1, '2018-05-09 14:04:15', 'female', 'huldra', 'eastern-continent', 200, 350),
(59, 'Garmund  Wispmote', 'garmund-wispmote', 999, -1, NULL, 1, '2018-05-09 14:04:20', 'male', 'huldra', 'eastern-continent', 200, 350),
(67, 'Frith Airsong', 'frith-airsong', 999, -1, 1, 1, '2018-05-16 08:40:43', 'female', 'huldra', 'eastern-continent', 200, 350);
...
--
ALTER TABLE `tblcreatures`
  MODIFY `creatureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `tblretinuequests`
  MODIFY `questID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=297;

--
-- AUTO_INCREMENT for table `tblretinuequestsactive`
--
ALTER TABLE `tblretinuequestsactive`
  MODIFY `questActiveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
