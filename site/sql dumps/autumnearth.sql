...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2016 at 04:40 PM
...
CREATE TABLE IF NOT EXISTS `tblplants` (
  ...
  `isAquatic` tinyint(1) NOT NULL DEFAULT '0',
...
(33, 'Xicaulan dermeruri ', 'Waterwhorl', 'A rare creeping native annual of dry grassland and roadside, with bright yellow flowers, often streaks of red. An excellent nector plant and a catapillar food plant for the Common Blue, Dingy Skipper and orange tip butterfly. Height: 10-40cm (4-16in) Perennial: Flowers May to Sept. Contains plant toxins.', 'xicaulan-dermeruri', 'Xicaulan dermeruri \r\n(Waterwhorl)', 0, '2016-03-30 13:14:14', 1459389921),
...
--
ALTER TABLE `tblplants`
  MODIFY `plantID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=42;
--
