...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2019 at 02:24 PM
...
--
ALTER TABLE `tblplants`
  MODIFY `plantID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=594;
...
--
ALTER TABLE `tblplayerhousing`
  MODIFY `mapHousingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
