...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2019 at 04:44 PM
...
--
ALTER TABLE `tblinventoryitems`
  MODIFY `itemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `tblplants`
  MODIFY `plantID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=591;
