...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2018 at 01:52 PM
...
(11, 18, 'newmemberchar2', 0, 0, 0, '', '', '', 0, '', '', NULL, 0, '', '', '', '', '', '', '', '', 0, '', '', '', 0, '2007-03-30', '-1'),
...
(2, 'Nellaith Wispfael', 'nellaith-wispfael', 999, 290, NULL, 1, '2018-05-09 14:04:15', 'female', 'huldra', 'eastern-continent', 200, 350),
(59, 'Garmund  Wispmote', 'garmund-wispmote', 999, 291, NULL, 1, '2018-05-09 14:04:20', 'male', 'huldra', 'eastern-continent', 200, 350),
(67, 'Frith Airsong', 'frith-airsong', 999, 287, 1, 1, '2018-05-09 14:03:35', 'female', 'huldra', 'eastern-continent', 201, 325);
...
--
ALTER TABLE `tblretinuequests`
  MODIFY `questID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=292;

--
-- AUTO_INCREMENT for table `tblretinuequestsactive`
--
ALTER TABLE `tblretinuequestsactive`
  MODIFY `questActiveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
