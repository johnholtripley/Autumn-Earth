...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2018 at 04:54 PM
...
INSERT INTO `tblcharacters` (`charID`, `accountID`, `charName`, `currentMap`, `tileX`, `tileY`, `bags`, `inventory`, `titlesEarned`, `activeTitle`, `professionsKnown`, `recipesKnown`, `totalGameTimePlayed`, `currentCards`, `stats`, `settings`, `fae`, `activePets`, `allPets`, `currency`, `npcsFollowing`, `lineOfSightRange`, `retinueMapAreasRevealed`, `collections`, `actions`, `guildID`, `guildmembersince`, `404MagicSquareSum`) VALUES
...
(2, 'Nellaith Wispfael', 'nellaith-wispfael', 999, 160, NULL, 1, '2018-05-01 12:52:47', 'female', 'huldra', 'eastern-continent', 76, 119),
(59, 'Garmund  Wispmote', 'garmund-wispmote', 999, 160, NULL, 1, '2018-05-01 12:52:47', 'male', 'huldra', 'eastern-continent', 239, 349),
(67, 'Frith Airsong', 'frith-airsong', 999, 167, 1, 1, '2018-05-01 12:51:01', 'female', 'huldra', 'eastern-continent', 200, 350);
...
--
ALTER TABLE `tblretinuequests`
  MODIFY `questID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;

--
-- AUTO_INCREMENT for table `tblretinuequestsactive`
--
ALTER TABLE `tblretinuequestsactive`
  MODIFY `questActiveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
