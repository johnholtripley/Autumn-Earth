...
function IEflash(Fwidth, Fheight, Fpath, Faltimage, Falttext, Fobjectname) {
	...
	document.write("<object codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0\" classid=\"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\" width=\""+Fwidth+"\" height=\""+Fheight+"\" name=\""+Fobjectname+"\"id=\""+Fobjectname+"\">");
	document.write("<param name=\"movie\" value=\""+Fpath+"\" />");
	document.write("<param name=\"quality\" value=\"high\" />");
	document.write("<param name=\"wmode\" value=\"transparent\" />");
	document.write("<embed src=\""+Fpath+"\" quality=\"high\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" wmode=\"transparent\" type=\"application/x-shockwave-flash\" width=\""+Fwidth+"\" height=\""+Fheight+"\" />");
...
function scrollPageLinks(anchorClicked,idToJumpTo) {
	...
	//
	// opera 8 and 9 - down links don't scroll - just jump
  // opera 5 and 6 - up links don't scroll - just jump
  // (original sitepoint code works in these browsers)
  //
